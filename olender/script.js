    ...
    jQuery(".art-hmenu>li>ul").each(function() {
        ...
        if (submenusWidth > sheetWidth) {
            ...
            jQuery(newlineLis).each(function(index, value) {
                jQuery("<li class=\"cleared\" style=\"padding-top:2px;height:5px;float:none;\"></div>").insertAfter(value);
            });
        }
...
jQuery(function ($) {
    ...
    var bgimages = "url('images/object924798578.png'),url('images/object1441757417.png'), ".split(",");
    var bgpositions = "787px 51px,706px 30px, ".split(",");
