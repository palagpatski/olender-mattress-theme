...
$art_style = '';
$art_head = '';
function olender_process_html(&$variables) {
 ...
 * @ingroup themeable
 */
function olender_button($variables) {
 ...
 */
function olender_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function olender_menu_local_task($variables) {
 ...
 */
function olender_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function olender_node_preview($variables) {
  $node = $variables['node'];
...
*/
function olender_form_alter(&$form, &$form_state, $form_id) {
...
function olender_form_element_label($variables) {
...
function olender_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
